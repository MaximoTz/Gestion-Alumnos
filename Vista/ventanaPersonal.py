...
class VentanaPersonal(QMainWindow):
    def __init__(self, rol_usuario, parent = None):
        super(VentanaPersonal, self).__init__(parent)
        uic.loadUi("UI/ventanaPersonal.ui", self)
        self.show()
        ...
        self.menu_VerListaDocentes.triggered.connect(self.opcionVerDocentes)
